[![SPASE Monthly Validation](https://github.com/hpde/GONG/actions/workflows/validate-schedule.yml/badge.svg)](https://github.com/hpde/GONG/actions/workflows/validate-schedule.yml)
[![SPASE Push Validation](https://github.com/hpde/GONG/actions/workflows/validate-push.yml/badge.svg)](https://github.com/hpde/GONG/actions/workflows/validate-push.yml)

# GONG

Global Oscillation Network Group (GONG) https://gong.nso.edu/

SPASE resource descriptions with the GONG naming authority.
